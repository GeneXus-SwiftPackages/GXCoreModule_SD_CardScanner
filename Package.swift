...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.11.xcframework.zip",
			checksum: "4a8e9a2d861321afe0ad3e4dea135086d3d36ea8e20238c1d4a715ebf544e199"
		)
	]
)