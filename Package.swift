...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.2.0-beta.14.xcframework.zip",
			checksum: "360a8b148b72fc78f8a2732903916ac959dcc1488bdf946f69584a266b22cc82"
		)
	]
)