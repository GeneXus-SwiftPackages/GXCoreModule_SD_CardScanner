...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.38.xcframework.zip",
			checksum: "460186596a763176a5b88327a6838962a90e52a1a98b5557a588786120395029"
		)
	]
)