...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.9.xcframework.zip",
			checksum: "69c5fef4f994cc9306d86f18f8bcf9643995d6b4e21c96dd647d14dedeea73d9"
		)
	]
)