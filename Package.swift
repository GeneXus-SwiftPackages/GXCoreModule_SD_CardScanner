...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.2.0-beta.33.xcframework.zip",
			checksum: "c4ecb2630cdc5e3c6b72f991ee29e3d750dd638a3a2d6441498af55305fbbc42"
		)
	]
)