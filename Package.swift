...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.17.xcframework.zip",
			checksum: "7fb3b213ad507f631f089e9085e2edba0ea5579eaed0cc44c95ef52c14814597"
		)
	]
)