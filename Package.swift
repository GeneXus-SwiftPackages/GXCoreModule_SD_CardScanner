...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.23.xcframework.zip",
			checksum: "40da12aa6fa6bba2faa80ee5e25bf8b12ec9a2fffe422e0a8cc6f2103a9bf578"
		)
	]
)