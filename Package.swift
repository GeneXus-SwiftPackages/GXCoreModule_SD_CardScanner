...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.26.xcframework.zip",
			checksum: "3a95058435d1af31e89f53e814bdc8ba7e7b4a731d965d97aba37e8ae5b93753"
		)
	]
)