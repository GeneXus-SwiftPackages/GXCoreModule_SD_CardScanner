...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.0.0-beta.13.xcframework.zip",
			checksum: "b5eb18b4b5e166613e427b78a9d4819580280b4752232fe94b450de053deffea"
		)
	]
)