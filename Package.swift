...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.8.xcframework.zip",
			checksum: "f962b6f5da63ea255d86827fcf5a672dde364fa8b695a6a723539870a3715e30"
		)
	]
)