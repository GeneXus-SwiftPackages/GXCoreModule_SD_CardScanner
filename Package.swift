...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.9.xcframework.zip",
			checksum: "6ae090110ab38fcbf87fd86e6dbc505f83777ff399393cf648f2529b23dccb82"
		)
	]
)