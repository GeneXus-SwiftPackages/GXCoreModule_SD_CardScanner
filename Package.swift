...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-1.1.2.xcframework.zip",
			checksum: "8e71af990cad5dd42ac6f64a42a559e7849461ca71d2fa96f7827ed064572b29"
		)
	]
)