...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.7.xcframework.zip",
			checksum: "eb7b53a7cfadeb5dec5cf48308ddf7d8d25decb391e1b6e2cc70ab6f12a41d03"
		)
	]
)