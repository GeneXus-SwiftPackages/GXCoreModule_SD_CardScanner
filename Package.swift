...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.9.xcframework.zip",
			checksum: "5d48543ca9b30b1b716b41e2a05358d5f3697af1fdc082f1ebbb4b3dfcf9ec87"
		)
	]
)