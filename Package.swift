...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.10.xcframework.zip",
			checksum: "3af517a8e051a0b6a2b461695a7e507e59ebafbcf8e3057ac363536c83028fe9"
		)
	]
)