...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.1.0-beta.8.xcframework.zip",
			checksum: "fe1447cd6c7a0e65b6c73db00f8a0f9b4c918af27d7b45f06b8da6dfa5a59b4b"
		)
	]
)