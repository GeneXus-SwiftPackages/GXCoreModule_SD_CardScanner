...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-4.0.8.xcframework.zip",
			checksum: "277940201c564f4dc3992b6341e168e8d2629598a8019a3898f98cc5956ca32c"
		)
	]
)