...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.1.0-beta.7.xcframework.zip",
			checksum: "6a18028554c1b2dfd77f6699d8fdc533b578a52da4abfa55444e173e02a9877a"
		)
	]
)