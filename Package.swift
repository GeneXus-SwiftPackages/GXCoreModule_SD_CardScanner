...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.1.0-beta.6.xcframework.zip",
			checksum: "46ca54297ee6ef3ab75c3aef425f3e1d610f7b3d5ba14dd84236763bc035639b"
		)
	]
)