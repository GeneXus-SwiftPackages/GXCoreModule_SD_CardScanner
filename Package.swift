...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.24.xcframework.zip",
			checksum: "b673f72d6c6b19a8afa808be6a1ae2ab5029a2396aaa8b657edc5df9b4702253"
		)
	]
)