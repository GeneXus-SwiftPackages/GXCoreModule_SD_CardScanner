...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.1.0-beta.17.xcframework.zip",
			checksum: "7a97ca0c528deccc9f237851ed45d0958801ad5567cbf4a47905dccc8ca0008a"
		)
	]
)