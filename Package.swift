...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.2.xcframework.zip",
			checksum: "0485381c96a179c22c6f5a77c5fc8ee527e17b48af5416ca79063e351f46d823"
		)
	]
)