...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.3.0-rc.13.xcframework.zip",
			checksum: "2e10fac09c414b8a4ffa969d1e79387e18481fe80375c572ff546a0357b49329"
		)
	]
)