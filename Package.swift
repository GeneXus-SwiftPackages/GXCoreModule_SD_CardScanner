...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.23.xcframework.zip",
			checksum: "8f983e0bbe2fc586b27b1652f24ca60bce6e99bc864c7348fd9a426e527de858"
		)
	]
)