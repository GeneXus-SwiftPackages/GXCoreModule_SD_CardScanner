...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-1.4.29.xcframework.zip",
			checksum: "42ea198cc73b54b2a5dfc57cfd70a78d91191aa72156c14f435c3d72cf494be5"
		)
	]
)