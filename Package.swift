...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.11.xcframework.zip",
			checksum: "9807a9b6519a32a965ff7675451fe73ddaabe4dbcdc814f01e4c7a156dfe3e95"
		)
	]
)