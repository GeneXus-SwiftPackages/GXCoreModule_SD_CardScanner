...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.0.0-beta.16.xcframework.zip",
			checksum: "5ac42cfb95af48e80ea41804de1e083fc1910b2634ae7f9919c9e81d99ca0b00"
		)
	]
)