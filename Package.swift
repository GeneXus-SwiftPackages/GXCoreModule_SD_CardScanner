...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.24.xcframework.zip",
			checksum: "c71fcb7d0b542f9cf8a2acafb104387ffa987351b1d9aa7856badf27d1905629"
		)
	]
)