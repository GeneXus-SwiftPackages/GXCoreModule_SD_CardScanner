...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.1.0-rc.3.xcframework.zip",
			checksum: "2cfad14b6866db0211e75bd1e20242af8f1228bcd7d905236203b29ebcd8fb42"
		)
	]
)