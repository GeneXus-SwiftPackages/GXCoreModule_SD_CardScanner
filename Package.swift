...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.0.0-preview.20230714192150.xcframework.zip",
			checksum: "227e4810f3fc0349399c5a24b815d31aeea7874823391c642162ec7f640dc62e"
		)
	]
)