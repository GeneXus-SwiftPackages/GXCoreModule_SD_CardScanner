...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-1.4.27.xcframework.zip",
			checksum: "00162acca403e2882bf9abf7156a98b8a7cb62da9be8124844706ee6a82fe8a5"
		)
	]
)