...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.6.0-beta.3.xcframework.zip",
			checksum: "50aee39027164d3d4d94043161d960d4950ca935bc12716fba2b7a4896f062a8"
		)
	]
)