...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.19.xcframework.zip",
			checksum: "6ca2f63d9979ee84a53d60cde0abf9b305c66e6b848530c8e8680600f76ec184"
		)
	]
)