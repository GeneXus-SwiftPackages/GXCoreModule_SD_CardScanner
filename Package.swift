...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-1.4.30.xcframework.zip",
			checksum: "17d9dee6a5ea35638d6161ba74a916ae939474231196180520623e647c11664f"
		)
	]
)