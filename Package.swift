...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.2.0-rc.36.xcframework.zip",
			checksum: "aeff7cdb4f5e33959ead5dbe5e642eb65ff9597c340f735febabc5e78bb57f26"
		)
	]
)