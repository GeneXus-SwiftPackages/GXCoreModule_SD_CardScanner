...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.16.xcframework.zip",
			checksum: "7e026a95907c90b6611aae5bc44adc6597b2b0d796f024cb06361bc377aa9489"
		)
	]
)