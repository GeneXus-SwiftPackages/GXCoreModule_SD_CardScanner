...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.7.xcframework.zip",
			checksum: "d848b0564197ec2dfc30f65696c127469fe327be220d45c84b249487c71efc48"
		)
	]
)