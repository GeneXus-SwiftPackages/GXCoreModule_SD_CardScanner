...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.32.xcframework.zip",
			checksum: "fb0570b60b9c2a12a25b5ccc362cc57c741c21f1c13853c37b20a974985bde24"
		)
	]
)