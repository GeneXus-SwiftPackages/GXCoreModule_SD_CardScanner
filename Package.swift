...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.2.0-beta.25.xcframework.zip",
			checksum: "9f68474c13502e7ce527c13291347c97843e010f0a3944951477ffbd9008d7f4"
		)
	]
)