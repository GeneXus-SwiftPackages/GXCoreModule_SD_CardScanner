...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.41.xcframework.zip",
			checksum: "747af04509440042c44230c12b8787e8f5b147bcd9862a8fc6ed8266a6e9f99e"
		)
	]
)