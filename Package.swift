...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.1.0-beta.794.xcframework.zip",
			checksum: "df420b9dd40b845f8bc0056f4e42dcaf02caa03fea714af1e4f06a3062f3e332"
		)
	]
)