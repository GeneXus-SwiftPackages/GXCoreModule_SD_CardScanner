...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.0.0-beta.45.xcframework.zip",
			checksum: "0c2b40b66ec8dd37e464779481591c929773014b97823862c3f443fd485f7913"
		)
	]
)