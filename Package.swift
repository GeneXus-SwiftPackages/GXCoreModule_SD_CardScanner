...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.13.xcframework.zip",
			checksum: "32bacfbc02f00fc986df3eda75080f5a389f686be0d3cfbb7c20145ca4778395"
		)
	]
)