...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.18.xcframework.zip",
			checksum: "7d5a21fcdf3cf8e2e7a3eca935c1e37c44bc82c031b13cee4a777ffd78cc1e33"
		)
	]
)