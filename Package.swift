...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.5.xcframework.zip",
			checksum: "438346ec2c3c18875182ef7fc2b42214c512ef32ff2b23eee597345c0186ad06"
		)
	]
)