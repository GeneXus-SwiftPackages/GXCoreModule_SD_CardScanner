...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.2.0-beta.15.xcframework.zip",
			checksum: "b1d253f2e6dd030e9d3df2c084c5eb16a9b84f41c30951198f44279984d27b20"
		)
	]
)