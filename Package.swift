...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.2.0-beta.21.xcframework.zip",
			checksum: "ad0219189f63634069fef42ed65af189a688694a43fc57f1e62b977a16600ec1"
		)
	]
)