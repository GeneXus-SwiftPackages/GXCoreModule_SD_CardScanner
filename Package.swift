...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-1.1.0-rc.1.xcframework.zip",
			checksum: "c4ac3b97ec97ed4cab91638902f92d53af822a4083945da6eb55b75c7a52756e"
		)
	]
)