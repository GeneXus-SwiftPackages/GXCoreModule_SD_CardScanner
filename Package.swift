...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.2.0-rc.25.xcframework.zip",
			checksum: "4ace8c9fbc668fe79ef96a861ccfae03d3bc09f5f6e6d8d460b10d3db65b4c3e"
		)
	]
)