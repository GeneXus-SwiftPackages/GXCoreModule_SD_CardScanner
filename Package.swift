...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.5.xcframework.zip",
			checksum: "2e61fd04fd4f508b5b86969ec7d431618363bc09650c7e8ca27d1591f217d899"
		)
	]
)