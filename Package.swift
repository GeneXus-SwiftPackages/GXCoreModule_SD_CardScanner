...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-2.0.0-rc.22.xcframework.zip",
			checksum: "581efa06d8944bd97b9762c11deb8cc07d1edd63fa14d603b974af2d119b4891"
		)
	]
)