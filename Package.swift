...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.3.0-rc.7.xcframework.zip",
			checksum: "80044d95c18f21f53d2a8e936a739a2f890043b69f87bfdaf99e821bab2b029f"
		)
	]
)