...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.31.xcframework.zip",
			checksum: "ad72994957b4c9e12619562a09cd61ab0e9da00f349416ee5aae18939209ddee"
		)
	]
)