...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-3.0.0-rc.8.xcframework.zip",
			checksum: "9cf47661f0c338364774b9dfff30c91f759ffb8bcbc95d57643dda63eb2eae08"
		)
	]
)