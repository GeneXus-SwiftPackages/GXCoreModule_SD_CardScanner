...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.3.xcframework.zip",
			checksum: "8cd70045a0826087a24d10139603789bdce8ef39957350cfb91b6c4da27a20ef"
		)
	]
)