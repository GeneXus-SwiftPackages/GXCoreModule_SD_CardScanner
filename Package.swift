...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.37.xcframework.zip",
			checksum: "8608e837b73a4d4b40f1475c55bd1185255ed1d218eb26c413e2737f7cdd422b"
		)
	]
)