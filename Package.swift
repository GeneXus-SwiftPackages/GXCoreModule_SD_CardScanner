...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.13.xcframework.zip",
			checksum: "2b657b2402e0c87b01e04e0875d393f4a33e0917ffda48d73e0ed276cbc27b8c"
		)
	]
)