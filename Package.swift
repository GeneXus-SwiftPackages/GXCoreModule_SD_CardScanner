...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.6.0-beta.0.xcframework.zip",
			checksum: "1518c6e49d13149f6f0ba01f1fc138d11992ca6da010a020e0b2e3662ca32928"
		)
	]
)