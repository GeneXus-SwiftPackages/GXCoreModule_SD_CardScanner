...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.2.0-beta.14.xcframework.zip",
			checksum: "8282d6643526d552b3fbc5e8569439504fc19c92369a72519cc27f860376d3fd"
		)
	]
)