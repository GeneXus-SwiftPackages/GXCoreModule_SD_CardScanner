...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.2.0-beta.23.xcframework.zip",
			checksum: "9ea9c0ddda3b172a09bd33de7d4713beffbd79cacd4ed4f6f8cad324424d326e"
		)
	]
)