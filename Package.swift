...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.1.0-beta.9.xcframework.zip",
			checksum: "9b6d981999b95d227bdd98053b6ab2433caa2db8610b0f2a2a4f9390907a8406"
		)
	]
)