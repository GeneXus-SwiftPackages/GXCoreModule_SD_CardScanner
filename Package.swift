...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.3.xcframework.zip",
			checksum: "c5db2a362e8b81ef2f50f9665134b8825da4c37a3108dedb260021711932c72f"
		)
	]
)