...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.0.0-beta.44.xcframework.zip",
			checksum: "80b969c51af7d5afa9d6b577087f47b27fc7e49d117b9f54ab04baac9eac9e31"
		)
	]
)