...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.0.0-beta.10.xcframework.zip",
			checksum: "df27c1fee9f8dc46e039a4e7f41f72e53f896a5ee774dd96142b6f0ab82dd864"
		)
	]
)