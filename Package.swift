...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.6.0-beta.4.xcframework.zip",
			checksum: "9a8d780e4911b2e7b3098fb0c2d2d1b538ee1da1cda903b839f1890634830276"
		)
	]
)