...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.30.xcframework.zip",
			checksum: "9885b35163bc8d54f198f88e74d2a49b202e9ee55f13fe820aa81227a015daac"
		)
	]
)