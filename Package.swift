...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.8.xcframework.zip",
			checksum: "b5cebbed71dab78ecb8a115a1e14fa416fa37c8854f16ca3759cd3e125fd66fa"
		)
	]
)