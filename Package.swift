...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-4.0.17.xcframework.zip",
			checksum: "ceaceb118910424b0fa50e026a9b05247ff063e81529217ec412ea3d3c26c217"
		)
	]
)