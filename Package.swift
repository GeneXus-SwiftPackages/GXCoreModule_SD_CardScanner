...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.1.0-beta.4.xcframework.zip",
			checksum: "9011f214b7c94915cdcf3dcc366d4461c4ceb96db4d9341f1da03fbcfe581042"
		)
	]
)