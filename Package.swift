...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.2.0-beta.38.xcframework.zip",
			checksum: "c1f48c9ab5f038f450fe9ce2d6440141bfe386be6b219d40dd57f34bb4ee52c7"
		)
	]
)