...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.37.xcframework.zip",
			checksum: "1f31711af0f8f28b7207d86be27f29e34af1ee638130b13f659e54e7501b464a"
		)
	]
)