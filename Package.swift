...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.7.xcframework.zip",
			checksum: "6d1de1ddc93389eae96498d32cc95f89b1713101c08750ae5c27fd285d31d121"
		)
	]
)