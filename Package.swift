...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.18.xcframework.zip",
			checksum: "ed34f2c80ec6c704416558b145e68e31962b82fb381e19c352e16d310ad46970"
		)
	]
)