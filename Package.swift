...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.11.xcframework.zip",
			checksum: "f7ed8ce03f05503d731b1a76429853ed8ca6ba47aca045ab19dd16812b855021"
		)
	]
)