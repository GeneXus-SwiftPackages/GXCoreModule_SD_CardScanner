...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-3.2.0.xcframework.zip",
			checksum: "0fe616661af9a480443ffc76616a39bf244500aa7da1c5d24a63e190faee0770"
		)
	]
)