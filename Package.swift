...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-3.2.0-rc.9.xcframework.zip",
			checksum: "ee102fb26e9b17c0ce134a16dd8f73b4053f4313178a62105d46311290aa188b"
		)
	]
)