...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-4.0.9.xcframework.zip",
			checksum: "d50dc65eaf2d5f1864adbd6a3ab09902cc620e7614affa0061b58b6db895e1e1"
		)
	]
)