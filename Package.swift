...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.6.xcframework.zip",
			checksum: "3e08fa1a2ff7897627710ccf5fd130bbafc1f5637ac1af9e8edb37448dfc4dd4"
		)
	]
)