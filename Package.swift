...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.1.0-beta.9.xcframework.zip",
			checksum: "580eeffdb62aaeac874d0c95bb56ded186b657046df9d8f7aba69be60d305d3f"
		)
	]
)