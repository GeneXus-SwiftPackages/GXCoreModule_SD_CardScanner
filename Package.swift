...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.7.xcframework.zip",
			checksum: "74d88fb35bbb316e4eb484a7fcc50e2ecaf4751c407b7653a2f18639e05a9d49"
		)
	]
)