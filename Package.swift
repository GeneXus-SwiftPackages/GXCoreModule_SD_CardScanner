...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.28.xcframework.zip",
			checksum: "81c418a8dbd6631f6603145908353fa5798a6f6ee191e48bac3faecc83f9a73c"
		)
	]
)