...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.0.0-beta.20230613192339.xcframework.zip",
			checksum: "322796c2af726f916b74c3dcc3d475e6b80505685dbcc4961ddc22f87bb2e8f5"
		)
	]
)