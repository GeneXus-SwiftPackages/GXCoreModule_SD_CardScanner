...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.0.0-beta.8.xcframework.zip",
			checksum: "1ef13defca46931c4f585513976cafb01b8feda5d2f351c4857148ec541eba11"
		)
	]
)