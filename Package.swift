...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.6.0-beta.1.xcframework.zip",
			checksum: "891fce5f613397db24cb97b719639f419840180be73bbaef094bb18f1c43e607"
		)
	]
)