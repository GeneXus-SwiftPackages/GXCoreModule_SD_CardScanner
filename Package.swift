...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.39.xcframework.zip",
			checksum: "2e5ad54c9eac3b949e5f932271bc0ef86eaa5c0a71054a7359148d3abcd5de7a"
		)
	]
)