...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.20.xcframework.zip",
			checksum: "d6439cdcbe4b385e73cff03c5d0700f176e4d209e20dafff97c66ed0992e92ba"
		)
	]
)