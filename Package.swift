...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.3.xcframework.zip",
			checksum: "aec640b6cd19b7e8de610e99aeeb63dc91e3607219a448c8a553d8f9e6396651"
		)
	]
)