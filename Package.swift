...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.1.xcframework.zip",
			checksum: "3fbf1ac404c307707b1a237bcd763e6f89ad9ce7a73d437f8e749c0efe96fc5f"
		)
	]
)