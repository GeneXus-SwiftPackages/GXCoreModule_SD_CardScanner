...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-2.0.18.xcframework.zip",
			checksum: "d97cb71ebc496de981ad2ea55a642a173f5b6f5916a02f4ad33dbaff9c10c4b0"
		)
	]
)