...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.16.xcframework.zip",
			checksum: "ed181db85de455637aaf26ebd9c169c17db82b365fb76f026bb01e01f96d9316"
		)
	]
)