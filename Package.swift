...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-4.1.5.xcframework.zip",
			checksum: "c513df66cf29e11df7a6a3c2c5baaabcff1cbb83c98bb62350d0b32c7a83a7d8"
		)
	]
)