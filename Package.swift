...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.2.0-rc.15.xcframework.zip",
			checksum: "7f4fa63244a90f8b3a251cfc537045809672a97958b589dcb15f0ee98850a6a5"
		)
	]
)