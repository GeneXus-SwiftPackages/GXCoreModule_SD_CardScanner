...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.1.0-rc.5.xcframework.zip",
			checksum: "ddbdcc952371807287c343ff8cab3b528be560df9105d322fa12a2bd4172f8c6"
		)
	]
)