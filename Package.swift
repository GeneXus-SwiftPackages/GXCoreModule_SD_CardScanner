...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.20.xcframework.zip",
			checksum: "0080d95ea6e7823e4d245f299a8651fc7db2d1d87cb7f7f7d30527d9eee78680"
		)
	]
)