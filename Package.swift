...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.28.xcframework.zip",
			checksum: "35752251c0ae18fdb57270f1bcfcfadccfc7b965b06e3bddff857a9a16fda4a2"
		)
	]
)