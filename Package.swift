...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.1.0-beta.24.xcframework.zip",
			checksum: "8cdd26ad0209c1141928bd54d443ee854d0e2ab509633035f083f116e37fbd48"
		)
	]
)