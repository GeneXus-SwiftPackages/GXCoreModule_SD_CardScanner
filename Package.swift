...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.1.0-beta.23.xcframework.zip",
			checksum: "9aa7c02a6ff43fb82bf5176ae9dfd7e2a94bb8c494e41a9add052fd804427e46"
		)
	]
)