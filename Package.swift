...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-1.4.31.xcframework.zip",
			checksum: "623e4642aad813c5eb98c307fcb32666d294550e466e764c20f54327732b6af6"
		)
	]
)