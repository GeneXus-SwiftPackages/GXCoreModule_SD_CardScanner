...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.6.xcframework.zip",
			checksum: "6556e3ef894749f0b122956c4e527d0897ccc2d888b561902919d326495d6a2d"
		)
	]
)