...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.17.xcframework.zip",
			checksum: "c6c0f19936cf3b3a5e0b725d1c592b83cc563fcaf8ccedcafd42e795477c71d3"
		)
	]
)