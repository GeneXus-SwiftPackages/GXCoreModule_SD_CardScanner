...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-1.6.0-rc.0.xcframework.zip",
			checksum: "e45e599fede11401d1d04f5724dbcb51f92196ecb3e16d5918f76873712cd2d5"
		)
	]
)