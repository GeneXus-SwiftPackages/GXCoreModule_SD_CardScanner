...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.16.xcframework.zip",
			checksum: "e2bf950e4b6df6cc3aee24e765850be3d20b4acb11afa6d69f308d9e668bebb4"
		)
	]
)