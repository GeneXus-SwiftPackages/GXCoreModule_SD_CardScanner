...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.2.0-beta.41.xcframework.zip",
			checksum: "94cefccc1f7c4f05d7539582e16ad91bfaa6a9c323afc76a679a6f026205884d"
		)
	]
)