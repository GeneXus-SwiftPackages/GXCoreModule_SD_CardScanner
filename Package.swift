...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.36.xcframework.zip",
			checksum: "156a8fbe11e32e20cbbd7349a7472b9a8afd41e5472cc4c0851fcaff92442bd5"
		)
	]
)