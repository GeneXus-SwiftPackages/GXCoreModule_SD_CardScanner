...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-1.3.6.xcframework.zip",
			checksum: "b7419691286b47c8cd0b5163dde7fe7e150f6bb8dcb95c42ef8b43260a01850b"
		)
	]
)