...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.2.xcframework.zip",
			checksum: "c32b43913cd065c4912007cd5efe0ed0bd148211685427096ebcdde0712cb29e"
		)
	]
)