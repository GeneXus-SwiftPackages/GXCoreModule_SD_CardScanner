...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-4.0.16.xcframework.zip",
			checksum: "307a930bfdf847491e5f0eefec3b70f5f81c610aa8e3495763d1a6e8fcdf5dad"
		)
	]
)