...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.2.0-beta.24.xcframework.zip",
			checksum: "16bc326713ea82630cfa2c1f5a9f790ad9ccc94e2dde3e6182b0c8942220aad7"
		)
	]
)