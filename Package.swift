...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.10.xcframework.zip",
			checksum: "6e1fd563ae8c2742008bd7161e5fbb9ae4bd947301d3f1d2257296a1f8e332a7"
		)
	]
)