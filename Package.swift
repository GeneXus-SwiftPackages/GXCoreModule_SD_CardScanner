...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.27.xcframework.zip",
			checksum: "86af91c8d9acea089d09f3ee0995f87522fe4dcd2a9babfe382ec6d55dfcc911"
		)
	]
)