...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.1.0-beta.24.xcframework.zip",
			checksum: "c87f42c70c60b8167d150a05565111f7b079d46230a34062e734dc42e33d6611"
		)
	]
)