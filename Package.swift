...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-3.0.1.xcframework.zip",
			checksum: "322ccd58ec780ec7a1a78391d3ad9aafd7d5a4d34d54370fb4158546ea704224"
		)
	]
)