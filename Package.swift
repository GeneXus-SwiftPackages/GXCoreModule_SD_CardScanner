...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.0.0-beta.49.xcframework.zip",
			checksum: "a8bc0fe80bd52b88fe69d970ea8a81cf82973fdda669a598c4b0b35780e81830"
		)
	]
)