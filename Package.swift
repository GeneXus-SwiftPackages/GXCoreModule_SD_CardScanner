...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.10.xcframework.zip",
			checksum: "a8c1ecac029ec6f15cdfd59abbd3d7f58347eef3b03a9b3219d93ead8dec6c59"
		)
	]
)