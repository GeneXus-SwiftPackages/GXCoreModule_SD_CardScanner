...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.1.0-beta.6.xcframework.zip",
			checksum: "dbe4917613b0046c5c0a9c2cab7191055c8c9b3be0722d95e79d2e7f3f4ab371"
		)
	]
)