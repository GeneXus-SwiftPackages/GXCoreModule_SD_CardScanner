...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-4.0.0-rc.0.xcframework.zip",
			checksum: "a0ed15178da9709d86851d72bcb8dcfea6560f0e0481f6cdcb6ab883bcb22b6c"
		)
	]
)