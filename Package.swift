...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-3.1.0-rc.3.xcframework.zip",
			checksum: "e29948fd26d1613cb14e4b758ba6628321a6531ee79bba9ffc6b888b1645f0a7"
		)
	]
)