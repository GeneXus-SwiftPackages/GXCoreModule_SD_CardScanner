...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.1.0-beta.24.xcframework.zip",
			checksum: "91bda9a735e59989d4f28906d7e78fbbc4940ba623c27eb0554ba970a6a90914"
		)
	]
)