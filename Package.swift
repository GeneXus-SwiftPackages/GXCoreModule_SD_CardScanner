...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.1.0-beta.25.xcframework.zip",
			checksum: "ed5570bacbbce44674e3a89f803f8dcd56253612f408f131bb30440ad08755ed"
		)
	]
)