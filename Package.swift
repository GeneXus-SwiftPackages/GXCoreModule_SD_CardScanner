...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-2.1.0-rc.25.xcframework.zip",
			checksum: "3369b552c40d7959115e51c1ba3ded5327b028d62b73f023d27c73ce9e13549e"
		)
	]
)