...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.27.xcframework.zip",
			checksum: "ab28ca92cdd6b7f50bf304fe6e987186a65b0a3a4769f3a9c91927eaa27786b9"
		)
	]
)