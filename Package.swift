...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.27.xcframework.zip",
			checksum: "710051f45857642ccd6ea7aa9f0c028b141fb2b5644808280188c1f3b4a632bc"
		)
	]
)