...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.1.0-beta.5.xcframework.zip",
			checksum: "018ea2ada5677690964deffffe48f7ad75197e58f6ce942ab266df54f53f0d4b"
		)
	]
)