...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.2.0-beta.15.xcframework.zip",
			checksum: "35a75844cdd7e771508938dd7bb0070954b6699cecfe8fbed0e2d9f05b6a2650"
		)
	]
)