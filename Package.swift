...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.1.0-beta.11.xcframework.zip",
			checksum: "bea6730c5b6758ca936e066e9633daebb6b40f88c22f4133b4a0aac2fb65e239"
		)
	]
)