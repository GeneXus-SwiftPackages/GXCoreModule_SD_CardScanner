...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.6.0-beta.2.xcframework.zip",
			checksum: "d75b6bc6eca38d780265f41bd07743b6cb1e99055dbd995c022789a8e549abf8"
		)
	]
)