...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.29.xcframework.zip",
			checksum: "45d177c04e14022e0a17d27c5a69a7c620c294d1e4888aa13a7382baa6b577d7"
		)
	]
)