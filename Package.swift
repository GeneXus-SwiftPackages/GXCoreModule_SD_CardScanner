...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-3.0.0-rc.15.xcframework.zip",
			checksum: "5c5951ba8a267557c63dbb486845c2f93d0e9581adc3bc9492172f2a907eb625"
		)
	]
)