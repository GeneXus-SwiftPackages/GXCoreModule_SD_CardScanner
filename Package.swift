...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-3.1.0-beta.27.xcframework.zip",
			checksum: "056853fe5c4fcaf6c6dd806eb980699750f15f034414755b638cd8fbdd232791"
		)
	]
)