...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.21.xcframework.zip",
			checksum: "5ac2ecadd8bd702a0fac23ef954cb4f99c4771e57bede958c4a8f47fb127c3fd"
		)
	]
)