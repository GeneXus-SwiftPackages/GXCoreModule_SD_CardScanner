...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.2.0-beta.10.xcframework.zip",
			checksum: "151634ca0d3f356070d8d9bd1183a3487d593ae47dba0d0c3359fdf68fba5bf2"
		)
	]
)