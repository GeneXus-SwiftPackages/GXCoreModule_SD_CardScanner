...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.1.0-beta.795.xcframework.zip",
			checksum: "f27f024827d10ea341f9f202fef7a35c65a56b3b83df6b044bcbab72501f56e8"
		)
	]
)