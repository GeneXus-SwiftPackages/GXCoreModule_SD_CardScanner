...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.5.0-beta.15.xcframework.zip",
			checksum: "50734ea83dd5500cf160a47f05d1e815fff0d77c614e38f8cedc842f7d4f14c6"
		)
	]
)