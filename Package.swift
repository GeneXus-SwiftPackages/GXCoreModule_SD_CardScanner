...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.4.0-beta.14.xcframework.zip",
			checksum: "848e57e63eb8065616be6eaee8939963a7c0d6342b1a3b118bc8b62fb678df9c"
		)
	]
)