...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.14.xcframework.zip",
			checksum: "46cd66d5e11fe8b23e40de666840bb631c388d5170c3090d9b08e69d6ad39515"
		)
	]
)