...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.2.0-beta.22.xcframework.zip",
			checksum: "866a997eaa2cb6bd7b1483928e060e54a8286e58822a855cf150d244d8ea66e3"
		)
	]
)