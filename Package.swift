...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.28.xcframework.zip",
			checksum: "f8e29f90102107894054af31019cfdb11154d984a1481178d13eee3ff844717b"
		)
	]
)