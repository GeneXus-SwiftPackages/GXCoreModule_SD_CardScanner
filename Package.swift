...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-4.2.0-beta.24.xcframework.zip",
			checksum: "cc27c01930be8b58f011e7dbd32dbf4aaf4d769941696c58076ea1482ba4e0cd"
		)
	]
)