...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-4.1.1.xcframework.zip",
			checksum: "a8a42750ad6ce86d26dc7e52ffecbd5f41f983874d9b2db632bfa5e11a42042a"
		)
	]
)