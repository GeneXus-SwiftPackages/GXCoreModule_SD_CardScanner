...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.24.xcframework.zip",
			checksum: "2ecb0646500a028dca189667ff9994b202651b3a5f12c60ada9142d2a531f4a9"
		)
	]
)