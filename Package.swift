...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.3.0-beta.1.xcframework.zip",
			checksum: "de9fdcd301254cc06faac0bfb1912e5de73ca5285b29c3564b082b91d7357c01"
		)
	]
)