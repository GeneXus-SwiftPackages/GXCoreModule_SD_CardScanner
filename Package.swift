...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/preview/GXCoreModule_SD_CardScanner-2.0.0-rc.34.xcframework.zip",
			checksum: "e874fe0c2d44a6c42ac7e78c637c2c4a0326397ef5015cccb945feb815fae959"
		)
	]
)