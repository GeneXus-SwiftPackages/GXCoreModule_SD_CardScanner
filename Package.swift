...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.1.0-beta.12.xcframework.zip",
			checksum: "427e4aeac439ece3fb12d8a3a4c8da4aaac27fa3fe16c56e370668652a9c4fdd"
		)
	]
)