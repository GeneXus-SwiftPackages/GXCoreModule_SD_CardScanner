...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-2.0.0-beta.36.xcframework.zip",
			checksum: "c1704d852ccf99b629eb3c5d2184272bbeeef5a436c2178c81ab3f2ab4714907"
		)
	]
)