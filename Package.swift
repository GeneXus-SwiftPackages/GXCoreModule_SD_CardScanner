...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/beta/GXCoreModule_SD_CardScanner-1.2.0-beta.34.xcframework.zip",
			checksum: "c3a7d8e732f9b51b0704b082e901d8e03c4862ab67ddc6cbc9d9d2e1bf6ac6d3"
		)
	]
)