...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXCoreModule_SD_CardScanner",
			url: "https://pkgs.genexus.dev/iOS/releases/GXCoreModule_SD_CardScanner-3.1.5.xcframework.zip",
			checksum: "52b27706b23e1517b6d8343dcb2dbdd24ff13365ba23818abc675eebeb1da7c8"
		)
	]
)